...
public class InventoryData {
	...
	private static Map<String, ItemQuality> productQualityMap = new HashMap<String, ItemQuality>();
	...
	static {
		...
		productQualityMap.put("Concert backstage passes", new ItemQuality("Concert backstage passes", -1, -2, 0, true, false));
